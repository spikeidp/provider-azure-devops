...
PROJECT_NAME ?= provider-azure-devops
PROJECT_REPO ?= github.com/spikeidp/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_REPO ?= https://github.com/microsoft/terraform-provider-azuredevops.git
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-azuredevops_v1.1.1
...
REGISTRY_ORGS ?= 992382709572.dkr.ecr.us-east-1.amazonaws.com/providers
IMAGES = $(PROJECT_NAME)
...
XPKG_REG_ORGS ?= 992382709572.dkr.ecr.us-east-1.amazonaws.com/providers
# NOTE(hasheddan): skip promoting on xpkg.upbound.io as channel tags are
# inferred.
XPKG_REG_ORGS_NO_PROMOTE ?= 992382709572.dkr.ecr.us-east-1.amazonaws.com/providers
XPKGS = $(PROJECT_NAME)
...
xpkg.build.provider-azure-devops: do.build.images
